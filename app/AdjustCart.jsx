...
export default function AdjustCart (props) {
    ...
    return (
        <div className={"flex justify-start transition-all duration-600 overflow-hidden " + (props.delay ? "opacity-0 h-0 -translate-y-10 group-hover:opacity-100 group-hover:h-auto group-hover:translate-y-0 " : "") + (props.orientation === "row" ? "flex-row space-x-5 items-center" : "flex-col space-y-2 items-start")}>
