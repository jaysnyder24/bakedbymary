    ...
    return (
        ...
        <div className="flex flex-col justify-start items-start w-full md:w-1/3 h-auto md:h-full">
            ...
            <div className="hidden md:flex flex-row h-full w-full space-x-5 justify-start items-center">
                <div onMouseEnter={() => (setSelected("Default"))} onClick={() => (setSelected("Default"))} className="w-full h-full relative rounded-xl overflow-hidden hover:scale-110 group transition-all duration-300">
                ...
                <div onMouseEnter={() => (setSelected("One"))} onClick={() => (setSelected("One"))} className="w-full h-full relative rounded-xl overflow-hidden hover:scale-110 group transition-all duration-300">
                ...
                <div onMouseEnter={() => (setSelected("Two"))} onClick={() => (setSelected("Two"))} className="w-full h-full relative rounded-xl overflow-hidden hover:scale-110 group transition-all duration-300">
