...
export default async function Homepage() {
  ...
  return (
    <div className='w-full'>
      <main className='w-full flex justify-center items-start relative h-[80vh]'>
        <section className='max-w-7xl w-full h-full flex justify-start gap-20'>
          <div className='w-7/12 h-full flex flex-col justify-center items-start gap-10'>
            <h1 className='text-6xl md:text-8xl font-playfair text-pink-950 font-bold'>
              Cookies For Every Event
            </h1>
            <p className='font-poppins'>
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Mollitia
              asperiores cupiditate aspernatur, earum illo unde eius, ut
              recusandae quos possimus repudiandae temporibus quasi beatae
              adipisci consectetur nesciunt placeat non. Placeat.
            </p>
            <Link
              href={'/cookies'}
              className='px-5 py-3 rounded bg-pink-700 hover:bg-pink-800 transition-color duration-200 ease-in font-poppins text-white font-semibold'
            >
              Start An Order
            </Link>
          </div>
          <div className='w-5/12 h-full grid grid-flow-row grid-cols-2 gap-10 justify-center items-center'>
            <div className='col-span-1 row-span-1 rounded bg-pink-700'></div>
            <div className='col-span-1 row-span-1 rounded bg-pink-700'></div>
            <div className='col-span-1 row-span-1 rounded bg-pink-700'></div>
            <div className='col-span-1 row-span-1 rounded bg-pink-700'></div>
          </div>
      ...
      <main className='flex flex-col md:flex-row justify-center items-start w-full px-10 md:px-14 pt-10 md:pt-14 h-auto md:h-[70vh] bg-yellow-200'>
