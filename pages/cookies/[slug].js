    ...
    <div className='w-screen relative'>
      ...
      <main className='w-full h-screen overflow-y-auto max-w-[1400px] md:flex md:flex-row flex-col md:justify-between justify-start md:items-start items-center pt-[116px] md:pb-20 lg:pt-[156px] px-10 pb-[147px] mx-auto'>
        ...
        <div className='flex flex-col justify-start items-start w-full z-50'>
          ...
          <span className={'font-bold text-pink-600 text-xl leading-none z-30 ' + (cookie.metadata.type = "special" ? "mb-10" : "")}>${cookie.default_price.unit_amount / 100}{cookie.metadata.available === "special" ? "0" : ".00"} per half dozen</span>
