          ...
          <div className='flex flex-col justify-start items-start w-full h-full z-20'>
            <div className='w-full flex flex-col justify-between items-start px-10'>
              <div className='w-full h-full grow flex flex-col justify-start items-start z-10'>
                ...
                {lineup.length > 0 ? <p className='w-full md:w-1/2 text-black text-xl flex flex-row justify-start items-center mb-10'><span className='text-pink-600 font-bold leading-none mr-2'>Pickup Date:</span> Monday September 11th, 2023</p> : ""}
              </div>
            </div>
